								...
								<div class="product-item">
									<a href="{{url('product_view',$product->id)}}" class="product-img">
										...
										<div class="product-absolute-options">
											...
											<?php
											$discount=  (($product->product_selling_price - $product->product_discount_price)/$product->product_selling_price)*100;
											
											?>
											<span class="offer-badge-1">{{round($discount,1)}}% Discount</span>
